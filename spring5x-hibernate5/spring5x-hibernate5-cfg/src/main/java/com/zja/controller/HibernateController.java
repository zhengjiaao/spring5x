...
public class HibernateController {
    ...
    @ApiOperation(value = "Example根据属性查询数据", notes = "HibernateTemplate", httpMethod = "GET")
    public Object findByExample(@RequestParam Integer age,@RequestParam String userName) {
        return this.userService.findByExample(age,userName);
    }
